    ...
    <div className="p-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, pacienteId: e.target.value }))
                  }
                  required
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, profissionalId: e.target.value }))
                  }
                  required
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setForm((p) => ({ ...p, formaPagamento: e.target.value }))
                  }
                  className="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500"
                >
                  <option value="">Selecione</option>
      ...
      <div className="space-y-2">
        ...
        {consultas.map((c) => {
          ...
          const pc =
            pagamentoConfig[c.statusPagamento] || pagamentoConfig.pendente;
          const rowBorder =
            c.status === "cancelada"
              ? "border-red-200"
              : c.status === "reagendada"
          ...
          return (
            <div
              key={c.id}
              className={`bg-white rounded-xl border ${rowBorder} px-5 py-4 flex items-center gap-4`}
            >
              ...
              <div className="flex items-center gap-2 shrink-0">
                <span
                  className={`text-xs px-2.5 py-1 rounded-full font-medium ${pc.bg}`}
                >
                  {pc.label}
                </span>
                <span
                  className={`text-xs px-2.5 py-1 rounded-full font-medium ${sc.bg}`}
                >
                  {sc.label}
                </span>
              </div>
                  ...
                  <>
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (motivo !== null)
                          atualizarStatus(c.id, "cancelada", motivo);
                      }}
